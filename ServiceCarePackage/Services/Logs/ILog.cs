...
namespace ServiceCarePackage.Services.Logs
{
    internal interface ILog
    {
        ...
        void Fatal(Exception? exception, string messageTemplate, [CallerFilePath] string file = "", [CallerLineNumber] int line = 0, [CallerMemberName] string member = "", params object[] values);
        ...
        void Error(string messageTemplate, [CallerFilePath] string file = "", [CallerLineNumber] int line = 0, [CallerMemberName] string member = "", params object[] values);

        /// <inheritdoc cref="Error(string,object[])"/>
        /// <param name="exception">An (optional) exception that should be recorded alongside this event.</param>
        void Error(Exception? exception, string messageTemplate, [CallerFilePath] string file = "", [CallerLineNumber] int line = 0, [CallerMemberName] string member = "", params object[] values);
        ...
        /// <param name="messageTemplate">Message template describing the event.</param>
        /// <param name="values">Objects positionally formatted into the message template.</param>
        void Warning(string messageTemplate, [CallerFilePath] string file = "", [CallerLineNumber] int line = 0, [CallerMemberName] string member = "", params object[] values);

        /// <inheritdoc cref="Warning(string,object[])"/>
        /// <param name="exception">An (optional) exception that should be recorded alongside this event.</param>
        void Warning(Exception? exception, string messageTemplate, [CallerFilePath] string file = "", [CallerLineNumber] int line = 0, [CallerMemberName] string member = "", params object[] values);
        ...
        /// <param name="messageTemplate">Message template describing the event.</param>
        /// <param name="values">Objects positionally formatted into the message template.</param>
        void Information(string messageTemplate, [CallerFilePath] string file = "", [CallerLineNumber] int line = 0, [CallerMemberName] string member = "", params object[] values);

        /// <inheritdoc cref="Information(string,object[])"/>
        /// <param name="exception">An (optional) exception that should be recorded alongside this event.</param>
        void Information(Exception? exception, string messageTemplate, [CallerFilePath] string file = "", [CallerLineNumber] int line = 0, [CallerMemberName] string member = "", params object[] values);

        /// <inheritdoc cref="Information(string,object[])"/>
        void Info(string messageTemplate, [CallerFilePath] string file = "", [CallerLineNumber] int line = 0, [CallerMemberName] string member = "", params object[] values);

        /// <inheritdoc cref="Information(Exception?,string,object[])"/>
        void Info(Exception? exception, string messageTemplate, [CallerFilePath] string file = "", [CallerLineNumber] int line = 0, [CallerMemberName] string member = "", params object[] values);
        ...
        /// <param name="messageTemplate">Message template describing the event.</param>
        /// <param name="values">Objects positionally formatted into the message template.</param>
        void Debug(string messageTemplate, [CallerFilePath] string file = "", [CallerLineNumber] int line = 0, [CallerMemberName] string member = "", params object[] values);

        /// <inheritdoc cref="Debug(string,object[])"/>
        /// <param name="exception">An (optional) exception that should be recorded alongside this event.</param>
        void Debug(Exception? exception, string messageTemplate, [CallerFilePath] string file = "", [CallerLineNumber] int line = 0, [CallerMemberName] string member = "", params object[] values);
        ...
        /// <param name="messageTemplate">Message template describing the event.</param>
        /// <param name="values">Objects positionally formatted into the message template.</param>
        void Verbose(string messageTemplate, [CallerFilePath] string file = "", [CallerLineNumber] int line = 0, [CallerMemberName] string member = "", params object[] values);

        /// <inheritdoc cref="Verbose(string,object[])"/>
        /// <param name="exception">An (optional) exception that should be recorded alongside this event.</param>
        void Verbose(Exception? exception, string messageTemplate, [CallerFilePath] string file = "", [CallerLineNumber] int line = 0, [CallerMemberName] string member = "", params object[] values);
        ...
        /// <param name="messageTemplate">Message template describing the event.</param>
        /// <param name="values">Objects positionally formatted into the message template.</param>
        void Write(LogEventLevel level, Exception? exception, string messageTemplate, [CallerFilePath] string file = "", [CallerLineNumber] int line = 0, [CallerMemberName] string member = "", params object[] values);
    }
}
